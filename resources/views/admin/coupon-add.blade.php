        ...
        <div class="main-content-wrap">
            <div class="flex items-center flex-wrap justify-between gap20 mb-27">
                ...
                <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                    ...
                    <li>
                        <div class="text-tiny">Novi kupon</div>
                    </li>
                </ul>
            </div>
            <div class="wg-box">
                <form class="form-new-product form-style-1" method="POST" action="{{route('admin.coupon.store')}}">
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Kod kupona" name="code" tabindex="0" value="{{old('code')}}" aria-required="true" required="">
                    </fieldset>
                    ...
                    <fieldset class="category">
                        ...
                        <div class="select flex-grow">
                            <select class="" name="type">
                                ...
                                <option value="percent">Procentualni</option>
                            </select>
                        </div>
                    </fieldset>
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Vrijednost kupona" name="value" tabindex="0" value="{{old('value')}}" aria-required="true" required="">
                    </fieldset>
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Minimalni iznos korpe za ostvarivanje popusta" name="cart_value" tabindex="0" value="{{old('cart_value')}}" aria-required="true" required="">
                    </fieldset>
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="date" placeholder="Kupon je moguće iskoristiti do datuma" name="expiry_date" tabindex="0" value="{{old('expiry_date')}}" aria-required="true" required="">
                    </fieldset>
