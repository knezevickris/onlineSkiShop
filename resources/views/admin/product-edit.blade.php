                ...
                <div class="wg-box">
                    ...
                    <div class="cols gap22">
                        ...
                        <fieldset class="name">
                            ...
                            <input type="hidden" name="stock_status" value="{{$product->quantity == 0 ? 'ne' : 'da'}}">
                        </fieldset>
                        ...
                        <fieldset class="name">
                            ...
                            <div class="select mb-10">
                                <select class="" name="has_sizes">
                                    <option value="0"   {{$product->has_sizes == "0" ? "selected" : ""}}>Ne</option>
                                    <option value="1" {{$product->has_sizes == "1" ? "selected" : ""}}>Da</option>
                                </select>
                            </div>
                        </fieldset>
                        ...
                        <fieldset class="gender">
                            ...
                            <div class="select mb-10">
                                <select class="" name="gender">
                                    <option value="F"  {{$product->gender == "F" ? "selected" : ""}}>Ženski</option>
                                    <option value="M"  {{$product->gender == "M" ? "selected" : ""}}>Muški</option>
