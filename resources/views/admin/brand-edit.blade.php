        ...
        <div class="main-content-wrap">
                ...
                <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                    ...
                    <li>
                        <a href="{{route('admin.brands')}}">
                            <div class="text-tiny">Svi brendovi</div>
                        </a>
                    </li>
                    <li>
                        <i class="icon-chevron-right"></i>
                    ...
                    <li>
                        <div class="text-tiny">Izmjeni brend</div>
                    </li>
                </ul>
            </div>
            <!-- new-category -->
            <div class="wg-box">
                <form class="form-new-product form-style-1" action="{{route('admin.brand.update')}}" method="POST"
                    ...
                    <fieldset class="name">
                        <div class="body-title">Naziv brenda<span class="tf-color-1">*</span></div>
                        <input class="flex-grow" type="text" placeholder="Unesite naziv brenda" name="name"
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Simbolicko ime brenda" name="slug"
