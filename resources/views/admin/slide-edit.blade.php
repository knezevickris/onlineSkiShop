        ...
        <div class="main-content-wrap">
            <div class="flex items-center flex-wrap justify-between gap20 mb-27">
                ...
                <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                    ...
                    <li>
                        <div class="text-tiny">Izmjeni promociju</div>
                    </li>
                </ul>
            </div>
            <div class="wg-box">
                <form class="form-new-product form-style-1" action="{{route('admin.slide.update')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Unesite tagline" name="tagline" tabindex="0" value="{{$slide->tagline}}" aria-required="true" required="">
                    </fieldset>
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Unesite naslov" name="title" tabindex="0" value="{{$slide->title}}" aria-required="true" required="">
                    </fieldset>
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Unesite podnaslov" name="subtitle" tabindex="0" value="{{$slide->subtitle}}" aria-required="true" required="">
                    </fieldset>
                    @error('subtitle')<span class="alert alert-danger text-center">{{$message}}</span>@enderror
                    <fieldset class="name">
                        <div class="body-title">Link <span class="tf-color-1">*</span></div>
                        <input class="flex-grow" type="text" placeholder="Unesite link" name="link" tabindex="0" value="{{$slide->link}}" aria-required="true" required="">
                    </fieldset>
                    ...
                    <fieldset class="category">
                        ...
                        <div class="select flex-grow">
                            <select class="" name="status">
                                ...
                                <option value="1" @if($slide->status == "1") selected @endif>Aktivna</option>
                                <option value="0" @if($slide->status == "0") selected @endif>Neaktivna</option>
                            </select>
                        </div>
                    </fieldset>
