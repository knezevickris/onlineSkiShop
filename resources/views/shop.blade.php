            ...
            <div class="shop-sidebar side-sticky bg-body" id="shopFilter">
                ...
                <div class="accordion" id="color-filters">
                    <div class="accordion-item mb-4 pb-3" style="background-color: #FFFFFF; border: none">
                        <h5 class="accordion-header" id="accordion-heading-1">
                            <button class="accordion-button p-0 border-0 fs-5 text-uppercase" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#accordion-filter-2" aria-expanded="true" aria-controls="accordion-filter-2" style="background-color: #FFFFFF;">
                                Boje
                                <svg class="accordion-button__icon type2" viewBox="0 0 10 6" xmlns="http://www.w3.org/2000/svg">
                                    <g aria-hidden="true" stroke="none" fill-rule="evenodd">
                                        <path
                ...
                <div class="accordion" id="size-filters">
                    <div class="accordion-item mb-4 pb-3" style="background-color: #FFFFFF; border: none">
                        <h5 class="accordion-header" id="accordion-heading-size">
                            <button class="accordion-button p-0 border-0 fs-5 text-uppercase" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#accordion-filter-size" aria-expanded="true" aria-controls="accordion-filter-size" style="background-color: #FFFFFF;">
                                Veličine
                                <svg class="accordion-button__icon type2" viewBox="0 0 10 6" xmlns="http://www.w3.org/2000/svg">
                                    <g aria-hidden="true" stroke="none" fill-rule="evenodd">
                                        <path
                        ...
                        <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
                            ...
                            <div class="price-range__info d-flex align-items-center mt-2">
                                <div class="me-auto">
                                    ...
                                    <span class="price-range__min">250 KM</span>
                                </div>
                                <div>
                                    <span class="text-secondary">Najviša: </span>
                                    <span class="price-range__max">450 KM</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="d-flex justify-content-between mb-4 pb-md-2">
                    ...
                    <div class="shop-acs d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1">
                        <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0" aria-label="Sort Items"
                                name="total-number">
                            <option selected>Filteri za sortiranje</option>
                            <option value="1">Predloženi</option>
                            <option value="2">Najprodavaniji</option>
                            <option value="3">Abecedno, A-Z</option>
                            <option value="3">Abecedno, Z-A</option>
                            <option value="3">Najjeftinije</option>
                            <option value="3">Najskuplje</option>
                            <option value="3">Najstarije</option>
                            <option value="3">Najnovije</option>
                        </select>

                        <div class="shop-asc__seprator mx-3 bg-light d-none d-md-block order-md-0"></div>

                        <div class="col-size align-items-center order-1 d-none d-lg-flex">
                            <span class="text-uppercase fw-medium me-2">Još</span>
