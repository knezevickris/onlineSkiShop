...
@section('content')
    <main class="pt-90">
        ...
        <section class="shop-checkout container">
            <h2 class="page-title">Pregled narudžbe</h2>
            ...
            <div class="order-complete">
                <div class="order-complete__message">
                    ...
                    <h3>Narudžba je uspješno kreirana!</h3>
                    <p>Hvala. Vaša narudžba je prihvaćena.</p>
                </div>
                <div class="order-info">
                    ...
                    <div class="order-info__item">
                        <label>Finalna cijena</label>
                        <span>{{$order->total}} KM</span>
                    </div>
                    <div class="order-info__item">
                        <label>Naćin plaćanja</label>
                        <span>Gotovina</span>
                    </div>
                </div>
                    ...
                    <div class="checkout__totals">
                        ...
                        <table class="checkout-totals">
                            <tbody>
                                ...
                                <tr>
                                    <th>Popust</th>
                                    <td class="text-right">{{$order->discount}} KM</td>
                                </tr>
                                <tr>
                                    <th>Dostava</th>
                                ...
                                <tr>
                                    <th>PDV</th>
                                    <td class="text-right">{{$order->tax}} KM</td>
                                </tr>
                                <tr>
                                    <th>Ukupno za plaćanje</th>
                                    <td class="text-right">{{$order->total}} KM</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
