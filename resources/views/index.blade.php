        ...
        <div class="swiper-slide">
          <div class="overflow-hidden position-relative h-100">
            ...
            <div class="slideshow-text container position-absolute start-50 top-50 translate-middle">
              <h6 class="text_dash text-uppercase fs-base fw-medium animate animate_fade animate_btt animate_delay-3">NOVOSTI</h6>
              ...
              <a href="{{$slide->link}}" class="btn-link btn-link_lg default-underline fw-medium animate animate_fade animate_btt animate_delay-7"></a>
            </div>
          </div>
        </div>
      @endforeach
...
<div class="container mw-1620 bg-white border-radius-10">
  ...
  <section class="category-carousel container">
    <h2 class="section-title text-center mb-3 pb-xl-2 mb-xl-4">U PONUDI</h2>
  ...
  <section class="hot-deals container">
    <h2 class="section-title text-center mb-3 pb-xl-3 mb-xl-4">Na sniženju</h2>
    <div class="row">
      <div
                          ...
                          <div class="product-card__price d-flex">
                            <span class="money price text-secondary">
                                @if($sProduct->sale_price != $sProduct->regular_price)
                                    <s> {{$sProduct->regular_price}} KM </s> {{$sProduct->sale_price}} KM
                                @else
                                    {{$sProduct->regular_price}} KM
                                @endif
                            </span>
                          </div>
                        </div>
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="category-banner__item border-radius-10 mb-5">
          <img loading="lazy" class="h-auto" src="{{ asset('uploads/slides/female.jpg') }}" width="690" height="665" alt="" />
          <div class="category-banner__item-mark">
            WOMEN
          </div>
          <div class="category-banner__item-content">
            <h3 class="mb-0">Za žene</h3>
            <a href="{{ route('shop.gender', 'F') }}" class="btn-link text-uppercase fw-medium">Naruči odmah</a>
          </div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="category-banner__item border-radius-10 mb-5">
          <img loading="lazy" class="h-auto" src="{{ asset('uploads/slides/male.jpg') }}" width="690" height="665" alt="" />
          <div class="category-banner__item-mark">
            MEN
          </div>
          <div class="category-banner__item-content">
            <h3 class="mb-0">Za muškarce</h3>
            <a href="{{ route('shop.gender', 'M') }}" class="btn-link  text-uppercase fw-medium">Naruči odmah</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="products-grid container">
    <h2 class="section-title text-center mb-3 pb-xl-3 mb-xl-4">Izdvojeni artikli</h2>
                    ...
                    <div class="product-card__price d-flex align-items-center">
                      <span class="money price text-secondary">
                          @if($fProduct->sale_price != $fProduct->regular_price)
                              <s> {{$fProduct->regular_price}} KM </s> {{$fProduct->sale_price}} KM
                          @else
                              {{$fProduct->regular_price}} KM
                          @endif
                      </span>
                    </div>
                  </div>
